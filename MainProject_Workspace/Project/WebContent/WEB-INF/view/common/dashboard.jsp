...
<!-- 	<div id="dashboard-planning" class="row" -->
<!-- 		style="visibility: hidden; position: absolute;"> -->
<!-- 		<div class="col-xs-12 col-sm-6"> -->
<!-- 			<h4 class="page-header">Planned projects</h4> -->
<!-- 			<a href="#">Expense items</a><a href="#" class="pull-right">Project -->
<!-- 				members</a> -->
...
<!-- 				<tbody> -->
<!-- 					<tr> -->
<!-- 						<td class="m-ticker"><b>Network upgrade</b><span>Change -->
<!-- 								Dlink devices to Cisco</span></td> -->
<!-- 						<td class="m-price">Aug</td> -->
<!-- 						<td class="m-change">179459</td> -->
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<td class="m-ticker"><b>Improved power equipment</b><span>Nevada -->
<!-- 								datacenter</span></td> -->
<!-- 						<td class="m-price">Nov</td> -->
<!-- 						<td class="m-change">59411</td> -->
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<td class="m-ticker"><b>New ticket system</b><span>developed -->
...
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<td class="m-ticker"><b>New optical channels</b><span>6 -->
<!-- 								links</span></td> -->
<!-- 						<td class="m-price">Nov</td> -->
<!-- 						<td class="m-change">22359</td> -->
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<td class="m-ticker"><b>Load-balance system</b><span>based -->
<!-- 								on Linux</span></td> -->
...
<!-- 			</table> -->
<!-- 		</div> -->
<!-- 		<div class="col-xs-12 col-sm-6" id="planning-chart-1" -->
<!-- 			style="height: 250px;"> -->
<!-- 			<a href="#">Reports</a> -->
<!-- 		</div> -->
<!-- 		<div class="col-xs-12 col-sm-8" id="planning-chart-2" -->
<!-- 			style="height: 250px;"></div> -->
<!-- 		<div class="col-xs-12 col-sm-4" id="planning-chart-3" -->
<!-- 			style="height: 250px;"></div> -->
<!-- 		<div class="col-xs-8"> -->
...
<!-- 	<div id="dashboard-netmap" class="row" -->
<!-- 		style="visibility: hidden; position: absolute;"> -->
<!-- 		<div class="col-xs-12"> -->
...
<!-- 	<div id="dashboard-stock" class="row" -->
<!-- 		style="visibility: hidden; position: absolute;"> -->
<!-- 		<div class="col-xs-12"> -->
<!-- 			<h4 class="page-header">Stocks from Yahoo Finance</h4> -->
<!-- 			<div id="inputSymbol"> -->
<!-- 				<p>Enter Stock</p> -->
<!-- 				<input id="txtSymbol" class="required" Placeholder="Symbol" /> <input -->
<!-- 					id="startDate" class="datePick required" type="text" -->
<!-- 					Placeholder="From" /> <input id="endDate" class="datePick" -->
