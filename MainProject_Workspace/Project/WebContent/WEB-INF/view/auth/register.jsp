	...
	<div class="container">
		<div class="row">
			<div
				...
				<form action="addEmployee.box" role="form" method="post"
					id="addEmployee">
					<br />
					<h1>9goopBox</h1>
					<br />
					...
					<div class="row">
						...
						<%-- 																<a href="../ajax/idchk.jsp?cnt=${id}" data-width="400" --%>
						<!-- 																	data-height="200" class="btn btn-default btn-block btn-lg">중복확인</a> -->
						<!-- 							</div> -->
					</div>
			...
			<div class="box">
				...
				<div class="box-content" id="accordion">
					...
					<div>
						...
						<div>
							<div class="checkbox" style="float: right">
								<label> <input type="checkbox" checked>전화번호 수집에
					...
					<div>
						...
						<div>
							<div class="checkbox" style="float: right">
								<label> <input type="checkbox" checked>주소 수집에 동의
					...
					<div>
						...
						<div>
							<div class="checkbox" style="float: right">
								<label> <input type="checkbox" checked>비밀번호 수집에
									동의 <i class="fa fa-square-o"></i>
								</label>
							</div>
						</div>
