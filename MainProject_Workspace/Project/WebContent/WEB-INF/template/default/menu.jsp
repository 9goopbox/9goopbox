				...
				<ul class="nav main-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
						...
						<ul class="dropdown-menu">
							...
							<!-- 수정 -->
							<spring:url value="/home" var="homUrl" htmlEscape="true" />
							<li><a href="${homeUrl }">뉴스피드</a></li>
						</ul></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-medkit"></i> <span class="hidden-xs">재고관리</span>
					</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-users"></i> <span class="hidden-xs">인사 관리</span>
					</a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle">
							<i class="fa fa-cogs"></i> <span class="hidden-xs">시스템관리자</span>
					</a>
						<ul class="dropdown-menu">
